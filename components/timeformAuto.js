      ...
      <View style={styles.mediumCard}>
        ...
        <View style={styles.smallCard}>
          <View>
            <TextInput
              ...
              onChangeText={minMoisture =>
                setMinMoisture(parseFloat(minMoisture))
              }
              defaultValue={data.minMoisture.toString()}
            />
          </View>
        </View>
        ...
        <View style={styles.smallCard}>
          <View>
            <TextInput
              style={styles.textTime}
              onChangeText={maxMoisture =>
                setMaxMoisture(parseFloat(maxMoisture))
              }
              defaultValue={data.maxMoisture.toString()}
            />
          </View>
        </View>
