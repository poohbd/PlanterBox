        ...
        <View style={styles.container}>
          ...
          <View style={styles.inline}>
            ...
            <TouchableOpacity
              ...
              <View>
                <Image
                  style={styles.image_forum}
                  source={require('../assets/images/Vector.png')}
                />
                <Text style={styles.buttonText2}>Forum</Text>
                <Text style={styles.buttonText2}>Coming Soon</Text>
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.inline}>
            <TouchableOpacity
              ...
              <View>
                <Image
                  style={styles.image_forum}
                  source={require('../assets/images/cib_wikipedia.png')}
                />
            ...
            <TouchableOpacity
              disabled
              style={styles.lowerbutton}
              onPress={() => navigation.navigate('Tabs_Settings')}>
              <View>
                <Image
